# genpark-repository-scoped-agentic-rule-indexer-skill
...
> **GenPark AI Agent Skill** -- Repository scoped agentic rule indexer & architecture guideline injector (Cursor Rules)
